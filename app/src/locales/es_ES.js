export default {
  ...
  photoDirectory: {
    ...
    compressPreview: 'Comprimir vista previa',
    compressPreviewTip: 'Las miniaturas se comprimirán a 1920 px de ancho para acelerar la vista previa. Esto acelera la vista previa de eliminación de la máscara, pero ralentiza el proceso de carga.',
    cancel: 'Cancelar',
  },
  photoGallery: {
    back: '← Volver',
  ...
  photoEdit: {
    ...
    toneTab: 'Corrección de latitud',
    tonePivot: 'Pivote de exposición',
    toneCurve: 'Contraste de exposición',
    tonePivotLeft: 'Desplazar a la izquierda',
    tonePivotRight: 'Desplazar a la derecha',
    toneCurveLeft: 'Reducir contraste',
  ...
  languageMismatch: {
    message: 'El idioma del sistema difiere del idioma actual de la interfaz. ¿Cambiar al idioma del sistema?',
    yes: 'Sí',
    no: 'No',
    dontRemind: 'No, no volver a recordar'
  },
  about: {
